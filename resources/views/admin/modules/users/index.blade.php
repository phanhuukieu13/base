                                ...
                                <tbody>
                                    <tr class="format-table">
                                        ...
                                        <td class="action-button">
                                            <a href="{{ route('admin.users.edit',['id' => 1]) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
                                            ...
                                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm" onclick="confirm('Bạn có chắc chắn muốn xóa?')">
                                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <rect x="0" y="0" width="24" height="24"></rect>
